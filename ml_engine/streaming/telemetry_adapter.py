...
try:
    from ml_engine.streaming.feature_aggregator import FeatureAggregator, ML_FEATURE_COLUMNS
    from ml_engine.streaming.flow_state import FlowStateManager, FlowWindow, NormalizedEvent
except ImportError:
    try:
        from .feature_aggregator import FeatureAggregator, ML_FEATURE_COLUMNS
